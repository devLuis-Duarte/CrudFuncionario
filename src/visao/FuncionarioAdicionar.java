...
public class FuncionarioAdicionar extends javax.swing.JDialog {

    Funcionario f = new Funcionario();
    private boolean salvar = false;

    public FuncionarioAdicionar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public boolean isSalvou() { //retornar o valor de salvar
        return salvar;
    }
